...
def générer_le_fichier_Gcode():
    global type_du_fichier_d_exportation, nom_du_fichier_d_exportation, nombre_de_fichiers_générés, taille_de_la_feuille_x
    ...
    nouveau_liste_des_tracés = []
    for tracé in liste_des_tracés:
        nouveau_liste_tracé = []
        for (identifiant_tracé, points_tracé, couleur) in tracé:
            points = [(taille_de_la_feuille_x - points_tracé[0][0], taille_de_la_feuille_x - points_tracé[0][1]), (taille_de_la_feuille_x - points_tracé[1][0], taille_de_la_feuille_x - points_tracé[1][1])]
            nouveau_liste_tracé.append((identifiant_tracé, points, couleur))
        nouveau_liste_des_tracés.append(nouveau_liste_tracé)
    liste_des_tracés = nouveau_liste_des_tracés
    nouveau_liste_des_tracés = []
