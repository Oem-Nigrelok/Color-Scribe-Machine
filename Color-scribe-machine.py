...
# Création de la fenêtre de couleur
...
# Couleurs
def noir():
    global color, fenêtre_de_couleur
    if activité == 1:
        return
    color = "#000000"
...
def fermer_le_choix_autre_couleur():
    global color, entrée_texte_couleur, bouton_valider_le_choix_autre_couleur, fenêtre_de_couleur
    if activité == 1:
        return
    try:
...
def utiliser_couleur_palette_suivante():
    global liste_de_couleurs_utilisables, color, fenêtre_de_couleur
    if activité != 1:
...
def ajouter_couleur_à_la_palette():
    global liste_de_couleurs_utilisables, color
    if tuple(int(color.lstrip('#')[i : i + 2], 16) for i in (0, 2, 4)) not in liste_de_couleurs_utilisables:
        liste_de_couleurs_utilisables.append(tuple(int(color.lstrip('#')[i : i + 2], 16) for i in (0, 2, 4)))
...
def maj_palette_de_couleur():
    ...
    if activité != 1:
        if liste_de_couleurs_utilisables_de_base and not liste_de_couleurs_utilisables_ajoutées and not liste_de_couleurs_utilisables:
            if set(liste_de_couleurs_utilisables_de_base) == {(0, 0, 0), (255, 255, 255)}:
                liste_de_couleurs_utilisables = []
                liste_de_couleurs_utilisables_ajoutées = []
...
def afficher_la_palette():
    global liste_de_couleurs_utilisables_de_base, liste_de_couleurs_utilisables, liste_de_couleurs_utilisables_ajoutées
    print(" ")
...
fenêtre.bind("<N>", lambda event : noir())
fenêtre.bind("<Up>", lambda event : utiliser_couleur_palette_suivante())
fenêtre.bind("<Down>", lambda event : utiliser_couleur_palette_précédente())
fenêtre.bind("<Left>", lambda event : ajouter_couleur_à_la_palette())
fenêtre.bind("<Left>", lambda event : afficher_la_palette())
